                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-30 pb-60 px-30">
                        ...
                        <div class="appointment">
                            <div class="mb-30">
                                <label for="date"
                                    class="appoint-date text-black text-start fs-18 mb-1">{{ __('messages.date') }}
                                    :</label>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="appointmentAdd btn btn-secondary send-msg-btn w-100">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="send-btn rounded-2 btn btn-secondary send-msg-btn contact-btn"
                                            type="submit">

...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 mb-1 @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif >
                        ...
                        <div class="appointment">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    ...
                                    <label
                                        class="text-secondary fs-6 fw-5 mb-1 text-start">{{ __('messages.hour') }}:</label>
                                    <div class="row m-0">
                                        <div class="">

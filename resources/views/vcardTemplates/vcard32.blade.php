    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class=" d-flex flex-sm-row gap-4 flex-column px-30">
                <div class="profile-section  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                    <div class="card flex-sm-row gap-4 mb-20">
                        ...
                        <div class="card-body pt-sm-3 p-0 text-sm-start text-center">
                            <div class="profile-name">
                                <h2 class="text-secondary mb-0 fs-30 fw-6">
                                    {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                    @if ($vcard->is_verified)
                                        <i class="verification-icon bi-patch-check-fill"></i>
                                    @endif
                                </h2>
                                <p class="fs-18 text-gray mb-0">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-18 text-gray mb-0">{{ ucwords($vcard->job_title) }}</p>
                                <p class="fs-18 text-gray mb-0">{{ ucwords($vcard->company) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-gray profile-desc fs-14 text-sm-start text-center mb-0 mt-3">
                        {!! $vcard->description !!}
                    </div>
                </div>
                {{-- social-media --}}
                <div class="social-media-section mt-sm-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-30 px-30 pb-30 mb-3">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 pb-40 px-30 mb-4">
                        <div class="section-heading">
                        ...
                        <div class="appointment px-2">
                            <div class="mb-4">
                                <label for="date"
                                    class="appoint-date text-white fs-6 fw-5 mb-1 text-start d-block">{{ __('messages.date') }}:</label>
                                <div class="row">
                            ...
                            <div>
                                <label
                                    class="text-white fs-6 fw-5 mb-1 text-start d-block">{{ __('messages.hour') }}:</label>
                                <div class="mb-40">
                                ...
                                <div class="text-center px-sm-4 mx-sm-3">
                                    <button type="submit" class=" appointmentAdd btn btn-primary">
                                    ...
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product-card card">
                                            ...
                                            <div class="product-desc mt-auto">
                                                ...
                                                <p class="fs-14 text-gray mb-0"> {{ $product->description }}</p>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-30 px-30 pb-5">
                        <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 pb-5">
                        <div class="section-heading">
                            ...
                            @foreach ($vcard->blogs as $blog)
                                ...
                                <div class="px-30">
                                    <div class="blog-card card flex-sm-row gap-4">
                                        ...
                                        <div class="card-body p-0 ps-sm-3 text-start">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pb-50 px-30 {{ checkFeature('blog') && $vcard->blogs->count() ? 'pt-0' : 'pt-50' }}"
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 pb-40 px-40 mt-5">
                    <div class="section-heading">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-3 pb-40 px-40 " @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>

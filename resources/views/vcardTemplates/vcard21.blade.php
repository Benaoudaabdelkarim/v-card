        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-img @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-40 @if($vcard->cover_type == 2) profile-margin @endif">
                <div class="card flex-row align-items-end justify-content-sm-start">
                    <div class="card-img d-flex justify-content-center align-items-center @if($vcard->cover_type == 2) profile-margin-top @endif">
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                    <div class="card-body px-0 text-sm-start text-center @if($vcard->cover_type == 2) profile-des @endif">

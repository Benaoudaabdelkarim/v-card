                            ...
                            <div class="row">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box d-flex align-items-start">
                                            <div
                                                class="contact-icon mt-2 d-flex justify-content-center align-items-center">
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box d-flex align-items-start">
                                            <div
                                                class="contact-icon mt-2 d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/vcard19/email-icon.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                        ...
                                        <div class="contact-box d-flex align-items-start">
                                            ...
                                            <div class="contact-desc">
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="text-primary fs-14 fw-5" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        ...
                                        <div class="contact-box d-flex align-items-start">
                                            ...
                                            <div class="contact-desc">
                                                <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                    class="text-primary fs-14 fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                                <p class="text-black fs-12 mb-0">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-start">
                                            ...
                                            <div class="contact-desc">
                                                ...
                                                <p class="text-black fs-12 mb-0">{{ __('messages.setting.address') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>

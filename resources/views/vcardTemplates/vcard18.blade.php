    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            <div class="banner-section @if ($vcard->cover_type == 2) vcard-yt-link-18 @endif">
                ...
                <img src="{{ asset('assets/img/vcard18/curve-shape.png') }}" class="curve-img w-100 @if($vcard->cover_type == 2) d-none @endif" loading="lazy" />
            ...
            @if ((isset($managesection) && $managesection['banner']) || empty($managesection))
                ...
                @endif
            @endif
            <div class="profile-section pb-40 @if ($vcard->cover_type == 2) profile-margin @endif">
                <div class="card flex-sm-row-reverse align-items-center pt-sm-0 pt-4">
                    ...
                    <div class="card-body text-start pt-sm-5 px-0 @if ($vcard->cover_type == 2) profile-detail @endif">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-md-6 mt-40">
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-black mb-0 fw-5 fs-14">{{ __('messages.vcard.dob') }}
                                                </p>
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-3 mb-40">
                                        <button class="contact-btn send-btn btn btn-primary mb-2 rounded-2"
                                            type="submit">

                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pb-30">
                        ...
                        <div class="services-bg">
                            <img src="{{ asset('assets/img/vcard16/services-bg.png') }}" alt=""
                                class="" loading="lazy">
                        </div>
                                            ...
                                            <div
                                                ...
                                                <div class="product-amount text-primary  fs-18">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="text-dark">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="text-dark">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </a>

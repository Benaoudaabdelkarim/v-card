...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden bg-gray-300 @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="profile-section pb-30 px-40 @if ($vcard->cover_type == 2) profile-margin @endif">

...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden position-relative bg-black @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- Pwa support --}}
        ...
        {{-- profile section --}}
        <div class="profile-section px-40 pb-60 @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            <div class="card d-flex flex-sm-row gap-4 mb-5">
                ...
                <div class="card-body pt-sm-4 mt-sm-3 p-0 text-sm-start text-center">
                    <div class="profile-name">
                        ...
                        <p class="fs-20 text-primary mb-0 fw-6">{{ ucwords($vcard->occupation) }}</p>
                        <p class="fs-20 text-primary mb-0 fw-6">{{ ucwords($vcard->job_title) }}</p>
                        <p class="fs-20 text-primary mb-0 fw-6">{{ ucwords($vcard->company) }}</p>
                    </div>
                </div>
            </div>
            <div class="text-gray">
        ...
        {{-- social-media --}}
        <div class="social-media-section px-40" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                                        <img src="{{ asset('assets/img/vcard33/email.png') }}" />
                                    </div>
                        ...
                        @if ($vcard->phone)
                            <div class="col-sm-6 mb-4">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                                        <img src="{{ asset('assets/img/vcard33/phone.png') }}" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->dob)
                            <div class="col-sm-6 mb-sm-0 mb-4">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                                        <img src="{{ asset('assets/img/vcard33/dob.png') }}" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                                        <img src="{{ asset('assets/img/vcard33/location.png') }}" />
                                    </div>
                                    <div class="contact-desc">
        ...
        @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
            @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                <div class="appointment-section pt-60 px-40" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="section-heading mb-5 text-center text-white">
                    ...
                    <div class="appointment">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="mt-3">
                                    <button class="appoint-btn appointmentAdd btn btn-gradient w-100">
                ...
                <div class="blog-section pt-60">
                    ...
                    <div class="blog-slider px-30">
                        @foreach ($vcard->blogs as $blog)
                            <div>
                                <div class="blog-card card" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                    <div class="card-img">
        ...
        @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
            <div class="qr-code-section pt-30 pb-60 px-40">
                ...
                <div
                    class="qr-code mx-auto mt-5 position-relative @if (getLanguage($vcard->default_language) == 'Arabic') dir="
                    rtl" @endif">

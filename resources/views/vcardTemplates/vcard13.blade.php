        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-30 @if($vcard->cover_type == 2) profile-margin @endif">
                @if (getLanguage($vcard->default_language) != 'Arabic')
                    <div
                        class="card d-flex flex-sm-row-reverse align-items-sm-end align-items-center justify-content-end">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-white mb-0 fs-14">{{ __('messages.setting.address') }}
                                                </p>
                                            ...
                                            <div class="product-card card">
                                                <div class="product-img card-img">
                                                    <img src="{{ $product->product_icon }}"
                                                        class="img-fluid h-100 object-fit-contain" loading="lazy" />
                                                </div>
                                                <div class="product-desc card-body">
                                                    ...
                                                    <div class="product-amount text-primary text-center fw-5">
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="product-amount text-primary text-center fw-5">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>

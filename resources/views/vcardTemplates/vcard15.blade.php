    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="banner-section position-relative">
                ...
                <svg class="curve-shape @if ($vcard->cover_type == 2) d-none @endif" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 pb-40 px-30">
                        <h2 class="font-cormorant text-primary text-center mb-2">{{ __('messages.plan.gallery') }}
                        </h2>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-30 pb-30 px-30">
                        <h2 class="font-cormorant text-primary text-center mb-2">{{ __('messages.plan.products') }}
                        </h2>
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="blog-section pt-40 bg-gray-200">
                        <div class=" text-center mb-40">
                            <h2 class="font-cormorant text-primary text-center mb-2">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 pb-30 px-30">
                        <h2 class="font-cormorant text-primary text-center mb-0">{{ __('messages.feature.blog') }}
                        </h2>
                                    ...
                                    <a href="{{ $vcardBlogUrl  }}">
                                        <div class="blog-card card">
                                            ...
                                            <div class="card-body h-auto" style="min-height:auto!important">
                                                <h6 class="card-title text-primary fw-2 text-center">
                                                    {{ $blog->title }}</h6>
                                            </div>
                                        </div>
                                    </a>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="gallery-section pt-50  px-30">
                        <h2 class="font-cormorant text-primary text-center mb-2">{{ __('messages.vcard.iframe') }}
                        </h2>

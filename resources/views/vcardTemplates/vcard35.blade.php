...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                <div class="row">
                    <div class="col-sm-8">
                        <div class="card flex-sm-row align-items-center">
                            <div class="card-body text-sm-start text-center p-0">
                                <div class="profile-name">
                                    ...
                                    <p class="fs-16 text-gray-300 mb-0 fw-5">{{ ucwords($vcard->company) }}</p>
                                </div>
                            </div>
                ...
                {{-- social-media --}}
                <div class="social-media-section social-media mt-sm-0 mt-40 mb-40 d-flex flex-column gap-3 flex-wrap  justify-content-sm-start justify-content-center"
                    ...
                    @if (checkFeature('social_links') && getSocialLinkIcon($vcard))
                        @foreach (getSocialLinkIcon($vcard) as $social)
                            <a href="{{ $social['url'] }}" target="_blank" class="text-decoration-none w-100">
                                <div class="ps-2 pe-sm-4 pe-3 border-right-gray-200 social-icon-bg p-2 social-box position-relative d-flex align-items-center">
                                    <div class="social-icon me-5 d-flex justify-content-center align-items-center">
                                        {!! $social['icon'] !!}
                                    </div>
                                    <div class="title-icon" style="margin-left: 220px;">
                                        <p class="fs-16 mb-0 text-gray-300 fw-bold">{{ $social['name'] }}</p>
                                    </div>
                                </div>
                            </a>
                        @endforeach
                ...
                <div class="desc">
                    <div class="text-white bg-transparent fs-14 text-sm-start mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') text-right @endif"
                        @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        {!! $vcard->description !!}
                    </div>
                </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section position-relative pt-60 px-30">
                    ...
                    <div class="row align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        @if ($vcard->email)
                                ...
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <a href="mailto:{{ $vcard->email }}"
                                            class="text-white fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">{{ $vcard->email }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <a href="mailto:{{ $vcard->alternative_email }}"
                                            class="text-white fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">{{ $vcard->alternative_email }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="text-white fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                            class="text-white fw-5 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @if ($vcard->dob)
                            <div class="col-12 col-sm-6 mb-sm-0 mb-4">
                                <div class="contact-box d-flex align-items-center">
                                    ...
                                    <div class="contact-desc">
                                        <p
                                            class="mb-0 text-white fw-5 @if (getLanguage($vcard->default_language) == 'Arabic') me-1 @endif">
                                            {{ $vcard->dob }}</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-sm-6  mb-40">
                                            <div class="service-card h-100">
                                                ...
                                                <div class="card-body p-0">
                                                    <h3 class="card-title fs-18 fw-5 text-white">
                                    ...
                                    <div class="col-12 mb-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        @foreach ($vcard->services as $service)
                                            <div class="service-card card d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div
                                                    class="card-body p-0 @if (getLanguage($vcard->default_language) == 'Arabic') me-3 @endif">
                                                    <h3 class="card-title fs-18 fw-5 text-white">
                                                        {{ ucwords($service->name) }}
                                                    </h3>
                                                    <p
                        ...
                        <div class="appointment">
                            <div class="row">
                                ...
                                <div class="col-12 text-center mt-2">
                                    <button
                                        class="btn btn-primary appoint-btn appointmentAdd">{{ __('messages.make_appointments') }}</button>
                                </div>
                            </div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section position-relative pt-60">
                                            ...
                                            <div class="card-body px-0">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fw-5 fs-16 text-white">{{ $product->currency->currency_icon }}{{ number_format($product->price, 2) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="fw-5 fs-16 text-white">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                    @endif
                                                </div>
                                                <p class="text-gray-300 fs-14 mb-0"> {{ $product->description }} </p>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="me-5 mt-3 text-center view-more mb-5">
                            <a class="fs-6 text text-decoration-underline product-view-more ms-5"
                                    ...
                                    <div>
                                        <div class="testimonial-card">
                                            <div class="quote-img mb-4">
                                                <img src="{{ asset('assets/img/vcard35/quote-img.png') }}"
                                                    alt="quote" class="w-100" />
                                            </div>
                                            <div class="card-body p-0">
                                                <p
                                                    class="text-white fw-5 mb-4 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="">
                        <div class="section-heading center-heading mb-5 mt-5 text-center text-white">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-60" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="section-heading left-heading mx-30"
                            @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="blog-section pt-60 px-30">
                        ...
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $index => $blog)
                                ...
                                @if ($index % 2 == 0)
                                    <div>
                                        <div class="blog-card card px-sm-0 px-2 flex-sm-row flex-column justify-content-between align-items-center gap-4 mb-4"
                                            @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                ...
                                @else
                                    <div>
                                        <div class="blog-card card px-sm-0 px-2 flex-sm-row flex-column-reverse justify-content-between align-items-center gap-4 mb-4"
                                            @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60">
                    ...
                    <div class="px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="d-flex flex-wrap gap-5 align-items-center px-30">
                            ...
                            <div class="qr-code d-flex justify-content-center position-relative ms-auto me-sm-4"
                                id="qr-code-thirtyfive" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-40 mb-3">
                        <div class="section-heading mb-5 text-center text-white center-heading">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-60 px-30">
                    ...
                    <div class="contact-form position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-60 px-30 mb-5" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <h2 class="">{{ __('messages.create_vcard') }}</h2>
                    </div>
                    <div class="vcard-link-card card" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>

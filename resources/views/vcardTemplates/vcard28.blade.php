                ...
                <div class="rtl" dir="rtl">
                    <div class="profile-section px-30 @if ($vcard->cover_type == 2) profile-margin @endif">
                        ...
                        <div class="card d-flex flex-sm-row align-items-sm-end align-items-center mb-40 pt-4 ">
                            ...
                            <div
                                class="card-body p-0 text-sm-start text-center @if ($vcard->cover_type == 2) profile-detail @endif">
                                <div class="profile-name">
                                    <h2 class="text-black mb-0 fs-30">
                                        {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                        @if ($vcard->is_verified)
                                        ...
                                        <div class="product-desc card-body p-3 text-start">
                                            ...
                                            <p class="amount fs-20 fw-6 mb-0 text-purple lh-1">
                                                @if ($product->currency_id && $product->price)
                                                    <span
                                                        class="fs-18 fw-6 text-purple">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div
                            class="bars-btn pet-clinic-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">

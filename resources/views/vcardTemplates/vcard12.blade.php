...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            {{-- profile --}}
            <div class="profile-section pb-40 px-30 @if($vcard->cover_type == 2) profile-margin @endif">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-gray-100 mb-0 fs-14">{{ __('messages.vcard.dob') }}
                                                </p>
                                                <p class="mb-0 text-white">{{ $vcard->dob }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-card card">
                                            <div class="product-img card-img">
                                                <img src="{{ $product->product_icon }}"
                                                    class="img-fluid h-100 w-100" loading="lazy" />
                                            </div>

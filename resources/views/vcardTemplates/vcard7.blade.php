                                            ...
                                            <div class="card border-0 bg-transparent h-100">
                                                <div class="event-icon text-center h-100">
                                                    ...
                                                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="mb-0 event-text text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                                        {{ $vcard->phone }}</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card border-0 bg-transparent h-100">
                                                <div class="event-icon text-center h-100">
                                                    ...
                                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                                        class="mb-0 event-text text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="" method="post" id="newsLatterForm">
                                        ...
                                        <div class="mb-3 mt-5 d-flex gap-1 justify-content-center align-items-center email-input">
                                            <div class="w-100">
                                                <input type="email" class="email-input form-control bg-dark border-dark text-light"

...
@role(App\Models\Role::ROLE_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/whatsapp-stores*') ? 'd-none' : '' }}">
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/appointments*') ? 'd-none' : '' }}">
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/user-setting*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('admin/user-setting*') ? 'active' : '' }}"
            href="{{ route('user.setting.index') }}">{{ __('messages.settings') }}</a>
    </li>

    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/affiliations*') ? 'd-none' : '' }}">

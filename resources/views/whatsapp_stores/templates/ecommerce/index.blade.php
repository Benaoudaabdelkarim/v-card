...
<body>
    <div class="main-content mx-auto w-100 overflow-hidden d-flex flex-column justify-content-between">
        <div>
            <nav class="navbar navbar-expand-lg px-50 position-relative">
                <div class="container-fluid p-0">
                    ...
                    <div>
                        <h3 class="fs-30 fw-6 mb-0 d-none d-sm-block"><a href="{{ route('whatsapp.store.show', $whatsappStore->url_alias) }}" style="color: #212529 " >{{ __('messages.whatsapp_stores_templates.ecommerce') }}</a></h3>
                    </div>
                    ...
                    <a href="{{ route('whatsapp.store.products', ['alias' => $whatsappStore->url_alias, 'category' =>  $category->id]) }}" style="color: #212529">
                        <div>
                            <div class="category-box bg-white mx-auto">
                                ...
                                <p class="fs-20 fw-5 text-center lh-sm mb-0 text-black text-break">{{ $category->name }}</p>
                            </div>
                        </div>
                    </a>
                    @endforeach
                                    ...
                                    <div class="d-flex flex-column h-100 justify-content-between">
                                        ...
                                        <div class="d-flex gap-2 align-items-center justify-content-between">
                                            ...
                                            <button data-id="{{ $product->id }}"
                                                class="btn btn-primary d-flex justify-content-center align-items-center addToCartBtn">
        ...
        <footer class="position-relative">
            <p class="mb-0 fw-5 fs-18 text-center lh-sm">
    ...
    document.querySelectorAll(".dropdown-item").forEach((item) => {
        item.addEventListener("click", function() {
            ...
            document.getElementById(
                "dropdownMenuButton"
            ).innerHTML = `<img src="${selectedFlag}" class="flag" alt="flag" loading="lazy" loading="lazy"> ${selectedText}`;
        });
    });
</script>
